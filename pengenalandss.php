...
<?php include 'HeadTag.php'; ?>
	...
	<link rel="stylesheet" href="css/style.syllabus.css">
	...
	<div class="container_12">
		<div class="grid_10 wrapper">
			...
			<div class="grid_8 centerContent">
				<h3>Pengenalan DSS</h3>
				<table id="lists">
					<tr>
						<td style="width: 100px">PDF</td>
						<td>:</td>
						<td><a href="">CDG4G3_pengenalan_dss.pdf</a></td>
					</tr>
					<tr>
						<td>Presentation</td>
						<td>:</td>
						<td><a href="">CDG4G3_pengenalan_dss.pptx</a></td>
					</tr>
					<tr>
						<td>Audio</td>
						<td>:</td>
				...
				<span><a href="Syllabus.php">Back</a></span>
			</div>
